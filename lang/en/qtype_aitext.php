...
$string['expertmode_setting'] = 'Expert mode, prompt must include [[expert]] and [[response]]';
...
$string['thedefaultmarksscheme'] = '
1. Reasoning, Explanation & Examples — 50 % of defaultmark
Assesses depth of thought, logical justification, and ability to explain why the answer is correct.
Full marks for clear reasoning, step-by-step logic, and appropriate examples or evidence.
2. Accuracy / Correctness — 25 % of defaultmark
Checks whether the core facts, results, or conclusions are correct and consistent with accepted knowledge or logic.
3. Completeness / Coverage — 15 % of defaultmark
Evaluates whether all parts of the question are addressed and integrated into a coherent whole.
4. Clarity / Expression — 5 % of defaultmark
Measures structure, readability, and precision of language or notation.
5. Relevance / Focus — 5 % of defaultmark
Ensures the response stays on topic and avoids unnecessary or incorrect digressions.
Final mark = sum of all criteria, scaled so that total = defaultmark.';
$string['thedefaultprompt'] = 'You are an expert evaluator with extensive experience in grading written responses fairly and consistently. Your goal is to assess a student’s work based on the task instructions and criteria. Be objective and avoid bias toward style or personal opinion. Grade **strictly** according to the provided guidelines.';
...
$string['responselanguage'] = 'AI response language';
$string['responselanguage_desc'] = 'Choose whether AI feedback should always be in English, or in the same language as the student’s text.';
$string['responselanguage_auto'] = 'Same language as student’s text';
$string['responselanguage_english'] = 'Always respond in English';
